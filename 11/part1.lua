...
for i=1,max-subgrid_size do
    for j=1,max-subgrid_size do
        local total_power = 0
        for k=0,subgrid_size-1 do
            for l=0,subgrid_size-1 do
...
print(string.format("<%3d,%3d> (%d)", x_max_power, y_max_power, max_power))
